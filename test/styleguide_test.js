...
exports.styleguide = {
  ...
  custom_css: function(test) {
    ...
    var actual = grunt.file.read('tmp/custom_css.html');
    var expected = grunt.file.read('test/expected/custom_css.html');
    ...
    test.equal(actual, expected, 'should include custom css.');
    test.done();
  }
};
